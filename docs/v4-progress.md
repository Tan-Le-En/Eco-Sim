...
- Phase 22 photos + story mode:
  - Photo paths in docs/v4-photos.md (new: real-clan-jetty_cc25bfaa, real-jetty-town_ecd78f2c, real-monsoon-sea_1fb07f26, real-storm-beach_b8463a69, real-langkawi-boats_1bd7b85d, real-mangrove-roots_1515d591, real-mangrove-forest_9da87f9c, real-river-village_b342ee6a; all /manus-storage/...)
